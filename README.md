...
```bash
composer require simba-jirira-source/laravel-schema-contract
```

You may publish all of the package's resources at once:

```bash
php artisan vendor:publish --tag="laravel-schema-contract"
```
...
```bash
php artisan vendor:publish --tag="laravel-schema-contract-config"
```

### Publishing and Running the Migrations

```bash
php artisan vendor:publish --tag="laravel-schema-contract-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-schema-contract-views"
```

### Publishing the Translations

```bash
php artisan vendor:publish --tag="laravel-schema-contract-lang"
```

### Publishing the Public Assets

```bash
php artisan vendor:publish --tag="laravel-schema-contract-assets"
```
...
Thank you for considering contributing to Laravel Schema Contract! Please review our [contributing guide](.github/CONTRIBUTING.md) to get started.
...
Laravel Schema Contract is open-sourced software licensed under the [MIT license](LICENSE.md).
